...
#user_fail{color:red;}
#wizard {border:5px solid #789;font-size:12px;height:560px;margin:20px auto;width:570px;overflow:hidden;position:relative;-moz-border-radius:5px;-webkit-border-radius:5px;}
...
<div id="main">
   <form action="#" method="post">
    ...
    <div class="items">
      <div class="page">
               <h3>FACSS 2013Newcomers Information Management System</h3>
...
$(function(){
  ...
  $("#user").blur(function(){
    ...
    var changeUrl = "includes/checkdup.php?action=check&user_name="+blurUser;
