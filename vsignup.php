...
<div id="main">
   <form action="#" method="post">
    ...
    <div class="items">
      <div class="page">
               <h3>FACSS 2013 Pickup Sign Up</h3>
      ...
      <div class="page">
               ...
               <p><label>Phone Number：</label><input type="text" class="input" id="telephone" name="telephone" /><div id="check66"></div></p>
...
$(function(){
  ...
  var email;
      ...
      if(i==2){
        ...
        telephone = $("#telephone").val();
          if(telephone==""){
              $("#check66").html("<p id='user_fail'>Please fill your Phone Number</p>").fadeOut(2500);
          return false;            
        }
    }
    }
  ...
  $("#user").blur(function(){
    ...
    var changeUrl = "includes/vcheckdup.php?action=check&user_name="+blurUser;
