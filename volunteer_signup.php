...
#user_fail{color:red;}
#wizard {border:5px solid #789;font-size:12px;height:950px;margin:20px auto;width:570px;overflow:hidden;position:relative;-moz-border-radius:5px;-webkit-border-radius:5px;}
...
<body>
<div id="header">
   <div id="logo"><h1><a href="http://www.helloweba.com" title="返回hellowebaHomepage">helloweba</a></h1></div>
</div>

<div id="main">
   <h2 class="top_title"><a href="http://www.helloweba.com/view-blog-134.html">jQuery实现一个滚动的分步注册向导</a></h2>
   <p style="height:24px; line-height:24px; margin:16px">注：这只是一个演示demo，helloweba网站不会记录用户输入的信息，请放心使用。</p>
   <form action="#" method="post">
    ...
    <div class="items">
      ...
      <div class="page">
                <h3>Contact Information<br/><em>请告诉我们您的Personal Information。</em></h3>   
                <p><label>姓First name:</label><input type="text" class="input" id="name" name="name" /><div id="check4"></div></p>
      ...
      <div class="page">
               <h3>Complete Registration<br/><em>点击OKComplete Registration。</em></h3>
               <h4>Helloweba欢迎您！</h4>
...
$(function(){
  ...
  var email;
      ...
      if(i==2){
        ...
        name = $("#name").val();
          if(name==""){
              $("#check4").html("<p id='user_fail'>Last name is not avaible:( 名</p>").fadeOut(2500);
          return false;            
        }
  ...
  $("#user").blur(function(){
    ...
    var changeUrl = "includes/volunteercheckdup.php?action=check&user_name="+blurUser;
...
*/
  ...
  $("#sub").click(function(){
    ...
    //var user = $("#user").val();   
      ...
      $.ajax({   
         type: "POST",   
         url: "includes/volunteerinsert.php",   
         data: dataform,   
         success: function(msg){   
            if(msg==1){   
